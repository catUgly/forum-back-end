...
import net.sunofbeach.blog.response.MyAuthenticator;
...
public class EmailUtils {
    ...
    public static void sendRegisterVerifyCode(int code,String address) throws Exception {
        String userName = "forum1029@163.com"; // 发件人邮箱
        String password = "OLQCXMEWPLJZSYNQ"; // 发件人密码，其实不一定是邮箱的登录密码，对于QQ邮箱来说是SMTP服务的授权文本
        String smtpHost = "smtp.163.com"; // 邮件服务器
        String to = address;
        String subject = "论坛系统验证码"; // 主题
        String body = "您的验证码是：" + code + "，验证码有效时间为10分钟，若非本人，请忽略此邮件。"; // 正文，可以用html格式的哟
        EmailUtils emailUtils = EmailUtils.entity(smtpHost, userName, password, to, null, subject, body, null);
        emailUtils.send(); // 发送！
    }
    public static void sendRegisterVerifyCode(String topic,String content,String address) throws Exception {
        String userName = "forum1029@163.com"; // 发件人邮箱
        String password = "OLQCXMEWPLJZSYNQ"; // 发件人密码，其实不一定是邮箱的登录密码，对于QQ邮箱来说是SMTP服务的授权文本
        String smtpHost = "smtp.163.com"; // 邮件服务器
        String to = address;
        String subject = topic; // 主题
        String body = content; // 正文，可以用html格式的哟
        EmailUtils emailUtils = EmailUtils.entity(smtpHost, userName, password, to, null, subject, body, null);
        emailUtils.send(); // 发送！
    }
}